...
#include "main.h"
/*-----------------------------------------------------------*/
volatile unsigned int Idle_Time,Task_1_Time,Task_2_Time,Task_3_Time,Task_4_Time,Task_5_Time,Task_6_Time;
volatile unsigned int Total_Time,CPU_LOAD;
/*-----------------------------------------------------------*/
...
void Pin_20(void * pvParameters)
{
	...
	for(;;)
	{
		Total_Time=Idle_Time+Task_1_Time+Task_2_Time+Task_3_Time+Task_4_Time+Task_5_Time+Task_6_Time;
		CPU_LOAD=100-((Idle_Time*100)/Total_Time);
...
int main( void )
{
  ...
  /* ------------------- */
	...
	//xTaskCreate(Pin_23,"Load_2_Simulation",100,NULL,1,20,&Pin_23_Handler);				//{Periodicity: 20 , Deadline: 20, Execution time: 12ms}
	/* ------------------- */	
	vTaskStartScheduler();
	for(;;);
}
